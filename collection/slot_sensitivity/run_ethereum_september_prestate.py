#!/usr/bin/env python3
"""
Run prestate/poststate collection for Ethereum blocks from September 2025 only.
...
OUTPUT_DB = Path(DB_BASE_DIR) / 'slot_sensitivity' / 'prestate_poststate_ethereum_september_2025.duckdb'

run_september_collection(
    title="ETHEREUM SEPTEMBER 2025 PRESTATE/POSTSTATE COLLECTION",
    chain='ethereum',
    csv_file=CSV_FILE,
